...
/**
 * This API is a proprietary API that is only used by the indian weather application company, and it's not open to public.
 */
@Slf4j
public class PrivateWeatherAPI implements WeatherService {
     ...
     */
    @Override public double getTemperature(Location location) {
     ...
     */
    @Override public double getHumidity(Location location) {
