...
/**
 * Weather Service defines basic contract which the weather application company will follow throughout its all applications.
 * It is also required if in future they plan to integrate new weather providers.
 */
